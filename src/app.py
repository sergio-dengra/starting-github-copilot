...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games, skills training, and intramural competitions",
    ...
    "Music Ensemble": {
        "description": "Instrumental and vocal rehearsals for school performances",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Normalize email: some clients may send '+' as space in query strings
    if " " in email:
        email = email.replace(" ", "+")
